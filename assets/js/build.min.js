...
!(function (e, t) {
                    ...
                    for (t in e)
                        (i = e[t]),
                            ...
                            (c && i && (x.isPlainObject(i) || (o = Array.isArray(i)))
                                ? ((n = r[t]), (s = o && !Array.isArray(n) ? [] : o || x.isPlainObject(n) ? n : {}), (o = !1), (r[t] = x.extend(c, s, i)))
                                : void 0 !== i && (r[t] = i));
            return r;
        }),
        x.extend({
            ...
            map: function (e, t, n) {
                var i,
                    ...
                    r = 0,
                    a = [];
                if (_(e)) for (i = e.length; r < i; r++) null != (o = t(e[r], r, n)) && a.push(o);
            ...
            if (!o && (p(t), (t = t || f), g)) {
                ...
                if (n.qsa && !E[e + " "] && (!m || !m.test(e)) && (1 !== x || "object" !== t.nodeName.toLowerCase())) {
                    if (((v = e), (y = t), 1 === x && (Q.test(e) || B.test(e)))) {
                        for (((y = (ee.test(e) && ve(t.parentNode)) || t) === t && n.scope) || ((d = t.getAttribute("id")) ? (d = d.replace(ie, oe)) : t.setAttribute("id", (d = w))), a = (h = r(e)).length; a--;)
                            ...
                            : function (t, n, l) {
                                ...
                                if (m) {
                                    ...
                                    if (((h = [r ? m.firstChild : m.lastChild]), r && y)) {
                                        for (
                                            b = (f = (c = (d = (u = (p = m)[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === _ && c[1]) && c[2], p = f && m.childNodes[f];
                                        ...
                                        for (
                                            ;
                                            (p = (++f && p && p[g]) || (b = f = 0) || h.pop()) &&
                                            ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && ((d = (u = p[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [_, b]), p !== t));
                                        ...
                                        c = function () {
                                            ...
                                            if (!(t < s)) {
                                                ...
                                                (c = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                    h(c)
                                                        ? o
                                                            ? c.call(e, r(s, n, I, o), r(s, n, M, o))
                                                            : (s++, c.call(e, r(s, n, I, o), r(s, n, M, o), r(s, n, I, n.notifyWith)))
    ...
    function ae(e, t, n, i) {
        ...
        if (d && d[3] !== c) {
            for (l /= 2, c = c || d[3], d = +l || 1; r--;) x.style(e, t, d + c), (1 - s) * (1 - (s = a() / l || 0.5)) <= 0 && (r = 0), (d /= s);
                        ...
                        ? ("none" === n && ((c[d] = V.get(i, "display") || null), c[d] || (i.style.display = "")),
                            ...
                            (c[d] =
                                ((l = r = s = void 0),
                                    (r = (o = i).ownerDocument),
                                    (a = o.nodeName),
                                    (l = le[a]) || ((s = r.body.appendChild(r.createElement(a))), (l = x.css(s, "display")), s.parentNode.removeChild(s), "none" === l && (l = "block"), (le[a] = l)))))
    ...
    (de = m.createDocumentFragment().appendChild(m.createElement("div"))),
        (ue = m.createElement("input")).setAttribute("type", "radio"),
    ...
    function be(e, t, n, i, o) {
        ...
        for (u.textContent = "", f = 0; (s = p[f++]);)
            ...
            else if (((c = oe(s)), (r = me(u.appendChild(s), "script")), c && ve(r), n)) for (d = 0; (s = r[d++]);) he.test(s.type || "") && n.push(s);
        return u;
    }
    var we = /^([^.]*)(?:\.(.+)|)/;
    function xe() {
                ...
                x.event.add(e, t, {
                    ...
                    handler: function (e) {
                        ...
                        if (1 & e.isTrigger && this[t]) {
                            ...
                            else if (((r = o.call(arguments)), V.set(this, t, r), (i = n(this, t)), this[t](), r !== (s = V.get(this, t)) || i ? V.set(this, t, !1) : (s = {}), r !== s))
                ...
                for (
                    ...
                    (f = g = (a = we.exec(t[c]) || [])[1]),
                        ...
                        ((u = x.event.special[f] || {}),
                            ...
                            (u = x.event.special[f] || {}),
                            (d = x.extend({ type: f, origType: g, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && x.expr.match.needsContext.test(o), namespace: h.join(".") }, s)),
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--;)
                    if (((f = g = (a = we.exec(t[c]) || [])[1]), (h = (a[2] || "").split(".").sort()), f)) {
                        for (u = x.event.special[f] || {}, p = l[(f = (i ? u.delegateType : u.bindType) || f)] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = s = p.length; s--;)
                            (d = p[s]),
                                (!o && g !== d.origType) ||
                                (n && n.guid !== d.guid) ||
                ...
                for (r = x.event.handlers.call(this, l, c), t = 0; (o = r[t++]) && !l.isPropagationStopped();)
                    for (l.currentTarget = o.elem, n = 0; (s = o.handlers[n++]) && !l.isImmediatePropagationStopped();)
                        (l.rnamespace && !1 !== s.namespace && !l.rnamespace.test(s.namespace)) ||
                            ((l.handleObj = s), (l.data = s.data), void 0 !== (i = ((x.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, a)) && !1 === (l.result = i) && (l.preventDefault(), l.stopPropagation()));
    ...
    function De(e, t, n, i) {
        ...
        var o,
            ...
            m = t[0],
            v = h(m);
        if (v || (1 < p && "string" == typeof m && !f.checkClone && Ee.test(m)))
        ...
        if (p && ((r = (o = be(t, e[0].ownerDocument, !1, e, i)).firstChild), 1 === o.childNodes.length && (o = r), r || i)) {
            ...
            if (l)
                for (d = a[a.length - 1].ownerDocument, x.map(a, je), u = 0; u < l; u++)
                    (c = a[u]),
                        he.test(c.type || "") &&
                        !V.access(c, "globalEval") &&
                        x.contains(d, c) &&
                        (c.src && "module" !== (c.type || "").toLowerCase() ? x._evalUrl && !c.noModule && x._evalUrl(c.src, { nonce: c.nonce || c.getAttribute("nonce") }, d) : y(c.textContent.replace(Ae, ""), c, d));
        }
        return e;
    }
    function Ne(e, t, n) {
    ...
    x.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(f.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || x.isXMLDoc(e)))
                for (r = me(d), i = 0, o = (s = me(e)).length; i < o; i++)
                    (a = s[i]), "input" === (c = (l = r[i]).nodeName.toLowerCase()) && pe.test(a.type) ? (l.checked = a.checked) : ("input" !== c && "textarea" !== c) || (l.defaultValue = a.defaultValue);
            if (t)
                if (n) for (s = s || me(e), r = r || me(d), i = 0, o = s.length; i < o; i++) Le(s[i], r[i]);
                else Le(e, d);
    ...
    function ze(e, t, n) {
        ...
        return (
            (n = n || Ie(e)) &&
            ("" !== (r = n.getPropertyValue(t) || n[t]) || oe(e) || (r = x.style(e, t)),
                !f.pixelBoxStyles() && Pe.test(r) && He.test(t) && ((i = a.width), (o = a.minWidth), (s = a.maxWidth), (a.minWidth = a.maxWidth = a.width = r), (r = n.width), (a.width = i), (a.minWidth = o), (a.maxWidth = s))),
            void 0 !== r ? r + "" : r
        );
    }
    function qe(e, t) {
    ...
    function Ke(e, t, n, i, o, s) {
        ...
        for (; r < 4; r += 2)
            "margin" === n && (l += x.css(e, n + ne[r], !0, o)),
                i
                    ? ("content" === n && (l -= x.css(e, "padding" + ne[r], !0, o)), "margin" !== n && (l -= x.css(e, "border" + ne[r] + "Width", !0, o)))
                    : ((l += x.css(e, "padding" + ne[r], !0, o)), "padding" !== n ? (l += x.css(e, "border" + ne[r] + "Width", !0, o)) : (a += x.css(e, "border" + ne[r] + "Width", !0, o)));
    ...
    function Ge(e, t, n) {
        ...
        return (
            ((!f.boxSizingReliable() && o) || (!f.reliableTrDimensions() && E(e, "tr")) || "auto" === r || (!parseFloat(r) && "inline" === x.css(e, "display", !1, i))) &&
            e.getClientRects().length &&
            ((o = "border-box" === x.css(e, "boxSizing", !1, i)), (s = a in e) && (r = e[a])),
            (r = parseFloat(r) || 0) + Ke(e, t, n || (o ? "border" : "content"), s, i, r) + "px"
        );
    }
    ...
    x.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (s = typeof n) && (o = te.exec(n)) && o[1] && ((n = ae(e, t, o)), (s = "number")),
                    null != n &&
                    n == n &&
                    ("number" !== s || l || (n += (o && o[3]) || (x.cssNumber[a] ? "" : "px")),
    ...
    (x.Animation = x.extend(ct, {
                ...
                if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(f))
                    for (i in (u &&
                        ...
                        ((n.overflow = [h.overflow, h.overflowX, h.overflowY]),
                            ...
                            "none" === (d = x.css(e, "display")) && (c ? (d = c) : (ce([e], !0), (c = e.style.display || c), (d = x.css(e, "display")), ce([e]))),
        ...
        x.each({ slideDown: at("show"), slideUp: at("hide"), slideToggle: at("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== s && 8 !== s && 2 !== s)
                    return void 0 === e.getAttribute
                        ? x.prop(e, t, n)
                        : ((1 === s && x.isXMLDoc(e)) || (o = x.attrHooks[t.toLowerCase()] || (x.expr.match.bool.test(t) ? dt : void 0)),
                            void 0 !== n
                                ? null === n
            ...
            toggleClass: function (e, t) {
                ...
                return "boolean" == typeof t && i
                    ...
                    : h(e)
                        ...
                        : this.each(function () {
                            var t, o, s, r;
                            if (i) for (o = 0, s = x(this), r = mt(e); (t = r[o++]);) s.hasClass(t) ? s.removeClass(t) : s.addClass(t);
            ...
            if (
                ...
                for (s = 0; (r = v[s++]) && !t.isPropagationStopped();)
                    (f = r),
                        ...
                        (u = (V.get(r, "events") || Object.create(null))[t.type] && V.get(r, "handle")) && u.apply(r, n),
                        (u = c && r[c]) && u.apply && X(r) && ((t.result = u.apply(r, n)), !1 === t.result && t.preventDefault());
                return (
                    (t.type = y),
                    o ||
    ...
    (Mt.href = wt.href),
        x.extend({
            ...
            ajax: function (t, n) {
                ...
                if (
                    (v.promise(T),
                        (f.url = ((t || f.url || wt.href) + "").replace(Dt, wt.protocol + "//")),
                ...
                for (u in ((d = x.event && f.global) && 0 == x.active++ && x.event.trigger("ajaxStart"),
                    ...
                    f.hasContent
                        ...
                        : ((p = f.url.slice(o.length)),
                            ...
                            !1 === f.cache && ((o = o.replace($t, "$1")), (p = (_t.test(o) ? "&" : "?") + "_=" + xt.guid++ + p)),
                            (f.url = o + p)),
                ...
                function C(t, n, r, l) {
                    ...
                    c ||
                        ((c = !0),
                            ...
                            !u && -1 < x.inArray("script", f.dataTypes) && x.inArray("json", f.dataTypes) < 0 && (f.converters["text script"] = function () { }),
                            (w = (function (e, t, n, i) {
                                var o,
                                    s,
                                    r,
                            ...
                            u
                                ? (f.ifModified && ((_ = T.getResponseHeader("Last-Modified")) && (x.lastModified[o] = _), (_ = T.getResponseHeader("etag")) && (x.etag[o] = _)),
                                    204 === t || "HEAD" === f.type ? (k = "nocontent") : 304 === t ? (k = "notmodified") : ((k = w.state), (p = w.data), (u = !(m = w.error))))
                                : ((m = k), (!t && k) || ((k = "error"), t < 0 && (t = 0))),
                            (T.status = t),
                            (T.statusText = (n || k) + ""),
                            u ? v.resolveWith(h, [p, k, T]) : v.rejectWith(h, [T, k, m]),
                            T.statusCode(b),
                            (b = void 0),
                            d && g.trigger(u ? "ajaxSuccess" : "ajaxError", [T, f, u ? p : m]),
                            y.fireWith(h, [T, k]),
                            d && (g.trigger("ajaxComplete", [T, f]), --x.active || x.event.trigger("ajaxStop")));
                }
                return T;
            },
                                    ...
                                    ((n = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null),
                                        "abort" === e
                                            ...
                                            : "error" === e
                                                ...
                                                : s(Ft[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
                            };
                        }),
                            (a.onload = n()),
    ...
    x.ajaxSetup({
        ...
        x.ajaxPrefilter("json jsonp", function (t, n, i) {
            ...
            if (a || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    a ? (t[a] = t[a].replace(Qt, "$1" + o)) : !1 !== t.jsonp && (t.url += (_t.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
        ...
        (f.createHTMLDocument = (((Rt = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Rt.childNodes.length)),
        (x.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                    ...
                    (s = !n && []),
                    (o = A.exec(e)) ? [t.createElement(o[1])] : ((o = be([e], t, s)), s && s.length && x(s).remove(), x.merge([], o.childNodes)));
            var i, o, s;
        }),
        ...
        (x.offset = {
            setOffset: function (e, t, n) {
                ...
                "static" === c && (e.style.position = "relative"),
                    ...
                    (s = x.css(e, "top")),
                    (l = x.css(e, "left")),
                    ("absolute" === c || "fixed" === c) && -1 < (s + l).indexOf("auto") ? ((r = (i = d.position()).top), (o = i.left)) : ((r = parseFloat(s) || 0), (o = parseFloat(l) || 0)),
    ...
    (function (e, t) {
        ...
        function s(e, t) {
            ...
            var n = e.getBoundingClientRect(),
                ...
                s = 1;
            return (
                i(e) && t && ((o = n.width / e.offsetWidth || 1), (s = n.height / e.offsetHeight || 1)),
                { width: H(n.width / o), height: H(n.height / s), top: H(n.top / s), right: H(n.right / o), bottom: H(n.bottom / s), left: H(n.left / o), x: H(n.left / o), y: H(n.top / s) }
            );
        }
        function r(e) {
        ...
        function p(e, n, o) {
            ...
            return (
                (p || (!p && !o)) &&
                (("body" !== a(n) || u(d)) && (f = n !== t(n) && i(n) ? { scrollLeft: n.scrollLeft, scrollTop: n.scrollTop } : r(n)), i(n) ? (((h = s(n, !0)).x += n.clientLeft), (h.y += n.clientTop)) : d && (h.x = c(d))),
                { x: e.left + f.scrollLeft - h.x, y: e.top + f.scrollTop - h.y, width: e.width, height: e.height }
            );
        }
        function f(e) {
            var t = s(e),
                n = e.offsetWidth,
                i = e.offsetHeight;
            return 1 >= Math.abs(t.width - n) && (n = t.width), 1 >= Math.abs(t.height - i) && (i = t.height), { x: e.offsetLeft, y: e.offsetTop, width: n, height: i };
        }
        function h(e) {
                    ...
                    if (((o = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox")), -1 === navigator.userAgent.indexOf("Trident") || !i(e) || "fixed" !== d(e).position))
                        for (e = h(e); i(e) && 0 > ["html", "body"].indexOf(a(e));) {
                            ...
                            if (
                                ...
                                (o && "filter" === s.willChange) ||
                                (o && s.filter && "none" !== s.filter)
                            ) {
                                o = e;
                                break e;
                            }
        ...
        function T(e, n) {
            if ("viewport" === n) {
                ...
                var u = 0,
                    p = 0;
                n && ((a = n.width), (o = n.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((u = n.offsetLeft), (p = n.offsetTop))), (e = k((e = { width: a, height: o, x: u + c(e), y: p })));
            } else i(n) ? (((e = s(n)).top += n.clientTop), (e.left += n.clientLeft), (e.bottom = e.top + n.clientHeight), (e.right = e.left + n.clientWidth), (e.width = n.clientWidth), (e.height = n.clientHeight), (e.x = e.left), (e.y = e.top)) : ((p = l(e)), (e = l(p)), (a = r(p)), (n = null == (o = p.ownerDocument) ? void 0 : o.body), (o = R(e.scrollWidth, e.clientWidth, n ? n.scrollWidth : 0, n ? n.clientWidth : 0)), (u = R(e.scrollHeight, e.clientHeight, n ? n.scrollHeight : 0, n ? n.clientHeight : 0)), (p = -a.scrollLeft + c(p)), (a = -a.scrollTop), "rtl" === d(n || e).direction && (p += R(e.clientWidth, n ? n.clientWidth : 0) - o), (e = k({ width: o, height: u, x: p, y: a })));
            return e;
        }
        function C(e, t, o) {
            return (
        ...
        function $(e, t) {
            ...
            (c = e.rects.popper),
                (r = C(n((d = e.elements[d ? ("popper" === o ? "reference" : "popper") : o])) ? d : d.contextElement || l(e.elements.popper), r, a)),
                (d = E({ reference: (a = s(u)), element: c, strategy: "absolute", placement: t })),
                (c = k(Object.assign({}, c, d))),
                (a = "popper" === o ? c : a);
            var p = { top: r.top - a.top + i.top, bottom: a.bottom - r.bottom + i.bottom, left: r.left - a.left + i.left, right: a.right - r.right + i.right };
        ...
        function L(e) {
            ...
            return function (e, t, s) {
                ...
                void 0 === s && (s = o);
                var a = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, U, o), modifiersData: {}, elements: { reference: e, popper: t }, attributes: {}, styles: {} },
                    l = [],
                    c = !1,
                    d = {
                        state: a,
                        setOptions: function (s) {
                            return (
                                ...
                                (a.scrollParents = { reference: n(e) ? m(e) : e.contextElement ? m(e.contextElement) : [], popper: m(t) }),
                                (s = (function (e) {
                                    var t = b(e);
                                ...
                                a.orderedModifiers.forEach(function (e) {
                                    var t = e.name,
                                        n = e.options;
                                    (n = void 0 === n ? {} : n), "function" == typeof (e = e.effect) && ((t = e({ state: a, name: t, instance: d, options: n })), l.push(t || function () { }));
                                }),
                                d.update()
                            );
                        },
                        forceUpdate: function () {
                            if (!c) {
                                ...
                                if (j(t, (e = e.popper)))
                                    for (
                                        a.rects = { reference: p(t, y(e), "fixed" === a.options.strategy), popper: f(e) },
                                        a.reset = !1,
                                        ...
                                        if (!0 === a.reset) (a.reset = !1), (t = -1);
                                            ...
                                            e = n.fn;
                                            var i = n.options;
                                            (i = void 0 === i ? {} : i), (n = n.name), "function" == typeof e && (a = e({ state: a, options: i, name: n, instance: d }) || a);
                                        }
                            }
                        },
                        update: w(function () {
        ...
        function D(e) {
            ...
            if (u) {
                var b = y(i),
                    w = "clientHeight",
                    x = "clientWidth";
                b === t(i) && "static" !== d((b = l(i))).position && ((w = "scrollHeight"), (x = "scrollWidth")),
                    "top" === s && ((m = "bottom"), (p -= b[w] - o.height), (p *= c ? 1 : -1)),
                    "left" === s && ((g = "right"), (e -= b[x] - o.width), (e *= c ? 1 : -1));
            }
            return (
                (i = Object.assign({ position: a }, u && K)),
                c
                    ? Object.assign({}, i, (((h = {})[m] = r ? "0" : ""), (h[g] = f ? "0" : ""), (h.transform = 2 > (v.devicePixelRatio || 1) ? "translate(" + e + "px, " + p + "px)" : "translate3d(" + e + "px, " + p + "px, 0)"), h))
                    : Object.assign({}, i, (((n = {})[m] = r ? p + "px" : ""), (n[g] = f ? e + "px" : ""), (n.transform = ""), n))
            );
        }
        function N(e) {
            ...
            G = {
                ...
                fn: function (e) {
                    ...
                    (i = void 0 === i || i),
                        ...
                        (t.styles.popper = Object.assign({}, t.styles.popper, D(Object.assign({}, e, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: i, roundOffsets: n })))),
                        null != t.modifiersData.arrow && (t.styles.arrow = Object.assign({}, t.styles.arrow, D(Object.assign({}, e, { offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: n })))),
                ...
                fn: function (e) {
                    var t = e.state,
                        ...
                        o = (e = F.reduce(function (e, n) {
                            ...
                            return (o = (o = a[0]) || 0), (a = ((a = a[1]) || 0) * r), (s = 0 <= ["left", "right"].indexOf(s) ? { x: a, y: o } : { x: o, y: a }), (e[n] = s), e;
                        }, {}))[t.placement],
                        s = o.x;
                        ...
                        var f = [n].concat(s).reduce(function (e, n) {
                            return e.concat(
                                "auto" === x(n)
                                    ...
                                    })(t, { placement: n, boundary: a, rootBoundary: l, padding: r, flipVariations: u, allowedAutoPlacements: p })
                                    : n
                            );
                        }, []);
            ...
            ie = {
                ...
                fn: function (e) {
                    ...
                    var r = n.tetherOffset,
                        a = void 0 === r ? 0 : r,
                        l = $(t, { boundary: n.boundary, rootBoundary: n.rootBoundary, padding: n.padding, altBoundary: n.altBoundary });
                    n = x(t.placement);
                    ...
                    if (((a = { x: 0, y: 0 }), r)) {
                        if (o || s) {
                            ...
                            var E = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 };
                            (m = E[m]),
                                (v = E[v]),
                                (h = R(0, B(p[b], h[b]))),
                                (C = d ? p[b] / 2 - T - h - m - g : C - h - m - g),
                                (p = d ? -p[b] / 2 + T + h + v + g : c + h + v + g),
                                (d = t.elements.arrow && y(t.elements.arrow)),
                                (g = t.modifiersData.offset ? t.modifiersData.offset[t.placement][u] : 0),
                                (d = r[u] + C - g - (d ? ("y" === u ? d.clientTop || 0 : d.clientLeft || 0) : 0)),
                                (p = r[u] + p - g),
                                o && ((o = i ? B(_, d) : _), (k = i ? R(k, p) : k), (o = R(o, B(w, k))), (r[u] = o), (a[u] = o - w)),
                                s && ((o = (s = r[n]) + l["x" === u ? "top" : "left"]), (l = s - l["x" === u ? "bottom" : "right"]), (o = i ? B(o, d) : o), (i = i ? R(l, p) : l), (i = R(o, B(s, i))), (r[n] = i), (a[n] = i - s));
                        }
                        t.modifiersData[e] = a;
                    }
                },
            ...
            oe = {
                ...
                fn: function (e) {
                    ...
                    if (((e = S(a)), (a = 0 <= ["left", "right"].indexOf(a) ? "height" : "width"), s && r)) {
                        ...
                        (r = r[e] - n.rects.reference[e]),
                            (r = (s = (s = y(s)) ? ("y" === e ? s.clientHeight || 0 : s.clientWidth || 0) : 0) / 2 - l[a] / 2 + (u / 2 - r / 2)),
                            (a = R(o[c], B(r, s - l[a] - o[d]))),
                            (n.modifiersData[i] = (((t = {})[e] = a), (t.centerOffset = a - r), t));
                    }
                },
                effect: function (e) {
                    var t = e.state;
            ...
            se = {
                ...
                fn: function (e) {
                    ...
                    var n = t.rects.reference,
                        ...
                        s = $(t, { elementContext: "reference" }),
                        r = $(t, { altBoundary: !0 });
                    (n = I(s, n)),
                        (i = I(r, i, o)),
                        (o = M(n)),
                        (r = M(i)),
                        (t.modifiersData[e] = { referenceClippingOffsets: n, popperEscapeOffsets: i, isReferenceHidden: o, hasPopperEscaped: r }),
                        (t.attributes.popper = Object.assign({}, t.attributes.popper, { "data-popper-reference-hidden": o, "data-popper-escaped": r }));
                },
            },
            re = L({ defaultModifiers: [Y, V, G, Z] }),
            ae = [Y, V, G, Z, J, ne, ie, oe, se],
            le = L({ defaultModifiers: ae });
        (e.applyStyles = Z),
            (e.arrow = oe),
            (e.computeStyles = G),
            (e.createPopper = le),
    ...
    (function (e, t) {
        ...
        class ee extends F {
            ...
            _addEventListeners() {
                this._config.keyboard && H.on(this._element, "keydown.bs.carousel", (e) => this._keydown(e)),
                    "hover" === this._config.pause && (H.on(this._element, "mouseenter.bs.carousel", (e) => this.pause(e)), H.on(this._element, "mouseleave.bs.carousel", (e) => this.cycle(e))),
            ...
            _addTouchEventListeners() {
                ...
                n.find(".carousel-item img", this._element).forEach((e) => {
                    ...
                    this._pointerEvent
                        ? (H.on(this._element, "pointerdown.bs.carousel", (t) => e(t)), H.on(this._element, "pointerup.bs.carousel", (e) => i(e)), this._element.classList.add("pointer-event"))
                        : (H.on(this._element, "touchstart.bs.carousel", (t) => e(t)), H.on(this._element, "touchmove.bs.carousel", (e) => t(e)), H.on(this._element, "touchend.bs.carousel", (e) => i(e)));
            }
            _keydown(e) {
        ...
        H.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", ee.dataApiClickHandler),
        ...
        const oe = new RegExp("ArrowUp|ArrowDown|Escape"),
            ...
            ue = { offset: [0, 2], boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null, autoClose: !0 },
            pe = { offset: "(array|string|function)", boundary: "(string|element)", reference: "(string|element|object)", display: "string", popperConfig: "(null|object|function)", autoClose: "(boolean|string)" };
        class fe extends F {
            constructor(e, t) {
            ...
            show() {
                ...
                if (!H.trigger(this._element, "show.bs.dropdown", n).defaultPrevented) {
                    ...
                    "ontouchstart" in document.documentElement && !e.closest(".navbar-nav") && [].concat(...document.body.children).forEach((e) => H.on(e, "mouseover", h)),
                        this._element.focus(),
            ...
            _getConfig(e) {
                if (
                    ((e = { ...this.constructor.Default, ...U.getDataAttributes(this._element), ...e }),
                        d("dropdown", e, this.constructor.DefaultType),
                        "object" == typeof e.reference && !l(e.reference) && "function" != typeof e.reference.getBoundingClientRect)
                )
        ...
        H.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', fe.dataApiKeydownHandler),
            H.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", fe.dataApiKeydownHandler),
            H.on(document, "click.bs.dropdown.data-api", fe.clearMenus),
        ...
        class we extends F {
            ...
            show(e) {
                this._isShown ||
                    ...
                    H.trigger(this._element, "show.bs.modal", { relatedTarget: e }).defaultPrevented ||
                    ((this._isShown = !0),
                        ...
                        H.on(this._element, "click.dismiss.bs.modal", '[data-bs-dismiss="modal"]', (e) => this.hide(e)),
        ...
        class ke extends F {
            ...
            show(e) {
                this._isShown ||
                    H.trigger(this._element, "show.bs.offcanvas", { relatedTarget: e }).defaultPrevented ||
                    ((this._isShown = !0),
                        (this._element.style.visibility = "visible"),
                        this._backdrop.show(),
                        this._config.scroll || (new he().hide(), this._enforceFocusOnElement(this._element)),
                        this._element.removeAttribute("aria-hidden"),
                        this._element.setAttribute("aria-modal", !0),
                        this._element.setAttribute("role", "dialog"),
                        this._element.classList.add("show"),
            ...
            _initializeBackDrop() {
                return new ve({ isVisible: this._config.backdrop, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: () => this.hide() });
            }
        ...
        H.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function (e) {
            ...
            H.on(window, "load.bs.offcanvas.data-api", () => n.find(".offcanvas.show").forEach((e) => ke.getOrCreateInstance(e).show())),
            b(ke);
        ...
        class Pe extends F {
            ...
            show() {
                ...
                q.set(s, this.constructor.DATA_KEY, this),
                    this._element.ownerDocument.documentElement.contains(this.tip) || (c.appendChild(s), H.trigger(this._element, this.constructor.Event.INSERTED)),
                    this._popper ? this._popper.update() : (this._popper = t.createPopper(this._element, s, this._getPopperConfig(l))),
            ...
            setElementContent(e, t) {
                if (null !== e)
                    return l(t)
                        ? ((t = c(t)), void (this._config.html ? t.parentNode !== e && ((e.innerHTML = ""), e.appendChild(t)) : (e.textContent = t.textContent)))
                        : void (this._config.html ? (this._config.sanitize && (t = Ae(t, this._config.allowList, this._config.sanitizeFn)), (e.innerHTML = t)) : (e.textContent = t));
            }
            getTitle() {
            ...
            _getConfig(e) {
                ...
                return (
                    ...
                    ((e = { ...this.constructor.Default, ...t, ...("object" == typeof e && e ? e : {}) }).container = !1 === e.container ? document.body : c(e.container)),
                    "number" == typeof e.delay && (e.delay = { show: e.delay, hide: e.delay }),
                    "number" == typeof e.title && (e.title = e.title.toString()),
                    "number" == typeof e.content && (e.content = e.content.toString()),
                    d("tooltip", e, this.constructor.DefaultType),
                    e.sanitize && (e.template = Ae(e.template, e.allowList, e.sanitizeFn)),
                    e
                );
            }
            _getDelegateConfig() {
        ...
        const Ie = new RegExp("(^|\\s)bs-popover\\S+", "g"),
            ...
            He = { ...Pe.DefaultType, content: "(string|element|function)" },
            ze = {
        ...
        return b(Xe), { Alert: W, Button: R, Carousel: ee, Collapse: ie, Dropdown: fe, Modal: we, Offcanvas: ke, Popover: qe, ScrollSpy: Re, Tab: Be, Toast: Xe, Tooltip: Pe };
    }),
    (function (e) {
        "function" == typeof define && define.amd
        ...
        e.extend(e.easing, {
            ...
            easeOutElastic: function (e) {
                return 0 === e ? 0 : 1 === e ? 1 : t(2, -10 * e) * i((10 * e - 0.75) * c) + 1;
            },
            easeInOutElastic: function (e) {
                return 0 === e ? 0 : 1 === e ? 1 : e < 0.5 ? (-t(2, 20 * e - 10) * i((20 * e - 11.125) * d)) / 2 : (t(2, -20 * e + 10) * i((20 * e - 11.125) * d)) / 2 + 1;
            },
            ...
            return this.each(function () {
                ...
                var E = "",
                    ...
                    $ = function () {
                        ...
                        if (d >= i) {
                            jQuery(w).addClass("mean-remove"),
                                (S = !0),
                                jQuery(n).addClass("mean-container"),
                                jQuery(".mean-container").prepend('<div class="mean-bar">' + x + '<a href="#nav" class="meanmenu-reveal" style="' + t + '">Show Navigation</a><nav class="mean-nav"></nav></div>');
                            var o = jQuery(e).html();
                            jQuery(".mean-nav").html(o),
                                        ...
                                        ? (jQuery(".mean-nav ul ul").each(function () {
                                            jQuery(this).children().length &&
                                                jQuery(this, "li:first")
                                                    .parent()
                                                    .append('<a class="mean-expand" href="#" style="font-size: ' + s + '">' + g + "</a>");
                                        }),
                                ...
                                jQuery(E).click(function (e) {
                                    e.preventDefault(),
                                        !1 === C ? (E.css("text-align", "center"), E.css("text-indent", "0"), E.css("font-size", s), jQuery(".mean-nav ul:first").slideDown(), (C = !0)) : (jQuery(".mean-nav ul:first").slideUp(), (C = !1)),
                        ...
                        t.exports = function (e, t) {
                            ...
                            if (a(l)) {
                                ...
                                if (!document.getElementById("fit-vids-style"))
                                    (document.head || document.getElementsByTagName("head")[0]).appendChild((((c = document.createElement("div")).innerHTML = '<p>x</p><style id="fit-vids-style">' + o + "</style>"), c.childNodes[1]));
                                var d = r(t.players),
                                    u = r(t.ignore),
    ...
    (function (e) {
        var t = (function (e, t, n) {
            ...
            var s = t.documentElement,
                ...
                _ = function (t, n) {
                    var i;
                    !r && (i = e.picturefill || o.pf) ? (n && n.src && !t[l]("srcset") && t.setAttribute("srcset", n.src), i({ reevaluate: !0, elements: [t] })) : n && n.src && (t.src = n.src);
                },
                k = function (e, t) {
                    ...
                    var r,
                        ...
                        Q = function (e, n) {
                            var i,
                                o = e,
                                r = B(e);
                            for (L -= n, P += n, D -= n, N += n; r && (o = o.offsetParent) && o != t.body && o != s;)
                                (r = (k(o, "opacity") || 1) > 0) && "visible" != k(o, "overflow") && ((i = o.getBoundingClientRect()), (r = N > i.left && D < i.right && P > i.top - 1 && L < i.bottom + 1));
                            return r;
                        },
                        U = function () {
                            var e,
                                ...
                                for (n = 0, W++; n < e; n++)
                                    if (w[n] && !w[n]._lazyRace)
                                        if (!z || (i.prematureUnveil && i.prematureUnveil(w[n]))) J(w[n]);
                                            ...
                                            (((h = w[n][l]("data-expand")) && (u = 1 * h)) || (u = q),
                                                v ||
                                                ((v = !o.expand || o.expand < 1 ? (s.clientHeight > 500 && s.clientWidth > 500 ? 500 : 370) : o.expand),
                                                    (i._defEx = v),
                                                    (y = v * o.expFactor),
                                                    (b = o.hFac),
                                                    (I = null),
                                                    q < y && F < 1 && W > 2 && g > 2 && !t.hidden ? ((q = y), (W = 0)) : (q = g > 1 && W > 1 && F < 6 ? v : 0)),
                                                m !== u && ((O = innerWidth + u * b), (j = innerHeight + u), (f = -1 * u), (m = u)),
                                                (a = w[n].getBoundingClientRect()),
                                                (P = a.bottom) >= f && (L = a.top) <= j && (N = a.right) >= f * b && (D = a.left) <= O && (P || N || D || L) && (o.loadHidden || B(w[n])) && ((p && F < 3 && !h && (g < 3 || W < 4)) || Q(w[n], u)))
                                        ) {
                        ...
                        Z = S(function (e, t, n, i, s) {
                            ...
                            (p = x(e, "lazybeforeunveil", t)).defaultPrevented ||
                                (i && (n ? y(e, o.autosizesClass) : e.setAttribute("sizes", i)),
                                    (a = e[l](o.srcsetAttr)),
                                    (r = e[l](o.srcAttr)),
                                    s && (u = (c = e.parentNode) && f.test(c.nodeName || "")),
                                    (g = t.firesLoad || ("src" in e && (a || r || u))),
                                    (p = { target: e }),
                                    y(e, o.loadingClass),
                                    g && (clearTimeout(h), (h = d(R, 2500)), w(e, K, !0)),
                        ...
                        J = function (e) {
                            if (!e._lazyRace) {
                                var t,
                                    ...
                                    s = "auto" == i;
                                ((!s && p) || !n || (!e[l]("src") && !e.srcset) || e.complete || v(e, o.errorClass) || !v(e, o.lazyClass)) &&
                                    ((t = x(e, "lazyunveilread").detail), s && $.updateElem(e, !0, e.offsetWidth), (e._lazyRace = !0), F++, Z(e, t, s, i, n));
                            }
                        },
                        ee = A(function () {
                            (o.loadMode = 3), X();
                    ...
                    return {
                        _: function () {
                            (T = n.now()),
                                ...
                                e.MutationObserver ? new MutationObserver(X).observe(s, { childList: !0, subtree: !0, attributes: !0 }) : (s[a]("DOMNodeInserted", X, !0), s[a]("DOMAttrModified", X, !0), setInterval(X, 999)),
                                c("hashchange", X, !0),
                                ["focus", "mouseover", "click", "load", "transitionend", "animationend"].forEach(function (e) {
                                    t[a](e, X, !0);
                                }),
                                /d$|^c/.test(t.readyState) ? ne() : (c("load", ne), t[a]("DOMContentLoaded", X), d(ne, 2e4)),
                                i.elements.length ? (U(), C._lsFlush()) : X();
                        },
                        checkElems: X,
                        unveil: J,
                        _aLSL: te,
                ...
                $ = (function () {
                    var e,
                        ...
                        i = function (e, t, i) {
                            var o,
                                s = e.parentNode;
                            s && ((i = T(e, s, i)), (o = x(e, "lazybeforesizes", { width: i, dataAttr: !!t })).defaultPrevented || ((i = o.detail.width) && i !== e._lazysizesWidth && n(e, s, o, i)));
                        },
                        s = A(function () {
                            var t,
                                n = e.length;
        ...
        var t = /\blang(?:uage)?-([\w-]+)\b/i,
            ...
            o = {
                ...
                highlightElement: function (n, i, s) {
                    ...
                    if ((o.hooks.run("before-sanity-check", c), (l = c.element.parentElement) && "pre" === l.nodeName.toLowerCase() && !l.hasAttribute("tabindex") && l.setAttribute("tabindex", "0"), !c.code))
                        return o.hooks.run("complete", c), void (s && s.call(c.element));
        ...
        if (
            ((e.Prism = o),
                (s.stringify = function e(t, n) {
                    ...
                    var s = { type: t.type, content: e(t.content, n), tag: "span", classes: ["token", t.type], attributes: {}, language: n },
                        r = t.alias;
 ...
 */ "undefined" != typeof module && module.exports && (module.exports = Prism),
        ...
        value: function (e, t) {
            Prism.languages.markup.tag.inside["special-attr"].push({
                ...
                inside: {
                    ...
                    "attr-value": {
                        pattern: /=[\s\S]+/,
                        inside: { value: { pattern: /(^=\s*(["']|(?!["'])))\S[\s\S]*(?=\2$)/, lookbehind: !0, alias: [t, "language-" + t], inside: Prism.languages[t] }, punctuation: [{ pattern: /^=/, alias: "attr-equals" }, /"|'/] },
                    },
                },
            });
        },
                            ...
                            (f.onreadystatechange = function () {
                                ...
                                4 == f.readyState &&
                                    (f.status < 400 && f.responseText
                                        ? (r.setAttribute(t, i), (l.textContent = f.responseText), Prism.highlightElement(l))
                                        : (r.setAttribute(t, "failed"),
                                            f.status >= 400 ? (l.textContent = ((e = f.status), (n = f.statusText), "âœ– Error " + e + " while fetching file: " + n)) : (l.textContent = "âœ– Error: File does not exist or is empty")));
                            }),
                            f.send(null);
                    }
                }),
    ...
    (function (e, t) {
        ...
        return (
            ...
            (t.prototype.start = function (t) {
                function n(e) {
                    i.album.push({ alt: e.attr("data-alt"), link: e.attr("href"), title: e.attr("data-title") || e.attr("title") });
                }
                var i = this,
                    o = e(window);
                ...
                var d = o.scrollTop() + this.options.positionFromTop,
                    u = o.scrollLeft();
                this.$lightbox.css({ top: d + "px", left: u + "px" }).fadeIn(this.options.fadeDuration), this.options.disableScrolling && e("body").addClass("lb-disable-scrolling"), this.changeImage(r);
            }),
            (t.prototype.changeImage = function (t) {
                ...
                (r.onload = function () {
                    var a, l, c, d, u, p;
                    s.attr({ alt: n.album[t].alt, src: i }),
                        e(r),
                        s.width(r.width),
                        s.height(r.height),
                        (p = e(window).width()),
                        (u = e(window).height()),
                        (d = p - n.containerPadding.left - n.containerPadding.right - n.imageBorderWidth.left - n.imageBorderWidth.right - 20),
                        (c = u - n.containerPadding.top - n.containerPadding.bottom - n.imageBorderWidth.top - n.imageBorderWidth.bottom - n.options.positionFromTop - 70),
                        "svg" === o && (s.width(d), s.height(c)),
                        n.options.fitImagesInViewport
                            ? (n.options.maxWidth && n.options.maxWidth < d && (d = n.options.maxWidth), n.options.maxHeight && n.options.maxHeight < c && (c = n.options.maxHeight))
                            : ((d = n.options.maxWidth || r.width || d), (c = n.options.maxHeight || r.height || c)),
                        (r.width > d || r.height > c) &&
                        (r.width / d > r.height / c ? ((l = d), (a = parseInt(r.height / (r.width / l), 10)), s.width(l), s.height(a)) : ((a = c), (l = parseInt(r.width / (r.height / a), 10)), s.width(l), s.height(a))),
                        n.sizeContainer(s.width(), s.height());
                }),
            ...
            (t.prototype.sizeContainer = function (e, t) {
                ...
                o !== r || s !== a
                    ? this.$outerContainer.animate({ width: r, height: a }, this.options.resizeDuration, "swing", function () {
                        n();
                    })
                    : n();
            }),
                    ...
                    init: function (e) {
                        ...
                        return (function (e) {
                            ...
                            : (g.disableMutationObserver ||
                                ...
                                "DOMContentLoaded" === g.startEvent && ["complete", "interactive"].indexOf(document.readyState) > -1
                                    ? m(!0)
                                    : "load" === g.startEvent
                                ...
                                window.addEventListener("resize", (0, a.default)(m, g.debounceDelay, !0)),
                                window.addEventListener("orientationchange", (0, a.default)(m, g.debounceDelay, !0)),
            ...
            function (e, t) {
                (function (t) {
                    ...
                    function n(e, t, n) {
                        ...
                        return (
                            (t = s(t) || 0),
                            i(n) && ((_ = !!n.leading), (h = (k = "maxWait" in n) ? b(s(n.maxWait) || 0, t) : h), (T = "trailing" in n ? !!n.trailing : T)),
                            (u.cancel = function () {
                    ...
                    e.exports = function (e, t, o) {
                        var s = !0,
                            r = !0;
                        if ("function" != typeof e) throw new TypeError(a);
                        return i(o) && ((s = "leading" in o ? !!o.leading : s), (r = "trailing" in o ? !!o.trailing : r)), n(e, t, { leading: s, maxWait: t, trailing: r });
                    };
                }.call(
                    t,
                    (function () {
            ...
            function (e, t) {
                (function (t) {
                    ...
                    e.exports = function (e, t, i) {
                        ...
                        return (
                            (t = o(t) || 0),
                            n(i) && ((_ = !!i.leading), (h = (k = "maxWait" in i) ? y(o(i.maxWait) || 0, t) : h), (T = "trailing" in i ? !!i.trailing : T)),
                            (u.cancel = function () {
    ...
    (function (e) {
        function t(e, t) {
            return (
                (t = t || []),
                e.replace(/\x3c!--.*?--\x3e/gim, "").replace(/<\/?([a-z][a-z0-9]*)\b[^>]*>/gim, function (e, n) {
            ...
            return this.each(function () {
                ...
                function o() {
                    w
                        ...
                        : y > g[v].length
                            ? s()
                            : i.finishOnHover && i.pauseOnHover && f.hasClass("hover") && y <= g[v].length
                                ? (l.html(a()), (y += 1), o())
                ...
                function r() {
                    0 === y && i.fade
                        ? (clearTimeout(d),
                            l.fadeOut(i.fadeOutSpeed, function () {
                                l.html(a()),
                                    l.fadeIn(i.fadeInSpeed, function () {
                                        (y += 1), o();
                                    });
                            }))
                ...
                function a() {
                    ...
                    var s = "",
                        r = [];
                    for (t = 0; t < y; t++) {
                        for (o = null, n = 0; n < m[v].length; n++)
                            if (m[v][n] && m[v][n].start === t) {
                                o = m[v][n];
                                break;
                            }
                ...
                (i.finishOnHover || i.pauseOnHover) &&
                    (f.removeClass("hover"),
                        f.hover(function () {
                    ...
                    h.each(function (n, i) {
                        var o,
                            s = (u = t(e(this).html(), x));
                        o = [];
                        for (var r, a = /<\/?([a-z][a-z0-9]*)\b[^>]*>/im, l = /\/\s{0,}>$/m, c = []; null !== (r = a.exec(s));)
                            (0 !== o.length && -1 === o.indexOf(r[1])) ||
                                ((r = { tag: r[0], name: r[1], selfClosing: l.test(r[0]), start: r.index, end: r.index + r[0].length - 1 }), c.push(r), (s = s.slice(0, r.start) + s.slice(r.end + 1)), (a.lastIndex = 0));
                    ...
                    f.find("ul").after("<div></div>").remove(),
                    (l = f.find("div")),
                    n();
            });
        }),
            (e.fn.ticker.defaults = { random: !1, itemSpeed: 3e3, cursorSpeed: 50, pauseOnHover: !0, finishOnHover: !0, cursorOne: "_", cursorTwo: "-", fade: !0, fadeInSpeed: 600, fadeOutSpeed: 300 });
    })(jQuery),
    (function (e) {
        "use strict";
        var t;
        e(window).on("scroll", function () {
            ...
            e(".newsticker-list").ticker({ random: !1, itemSpeed: 3e4, cursorSpeed: 50, pauseOnHover: !0, finishOnHover: !1, cursorOne: "_", cursorTwo: "-", fade: !0, fadeInSpeed: 600, fadeOutSpeed: 300 }),
            AOS.init({ offset: 120, delay: 0, duration: 1e3, easing: "ease", once: !1, mirror: !1, anchorPlacement: "top-bottom" }),
